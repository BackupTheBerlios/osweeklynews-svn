...
do
   case $1 in
    -h|--help)
      printf "${0#*/} [--xml XMLFILE] [--xslt STYLESHEET] [--output MEDIAWIKIFILE] [PARAM=VALUE]*
...
Options:
 ...
 --xslt STYLESHEET  Use XSLT stylesheet  
                    (default $_XSLT)
 --output MEDIAWIKIFILE  Output result to MEDIAWIKIFILE 
                    (default $_OUT)
...
info "Find the MediaWiki file here: $PWD/${_OUT}"
